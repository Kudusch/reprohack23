...
subtitle: "What makes computational communication science (ir)reproducible?"
...
::: {style="font-size: 0.3em"}
[Van Atteveldt. (2019)](https://doi.org/10.5117/CCR2019.1.001.VANA)
:::
...
::: {.incremental}
* 6 / 30 or 1 / 30
* More than half **not** due to technical issues
* **Not** due to technical issues such as irreproducible computational environment, but incomplete sharing of data
