...
The most common reason for failure among the 14 tested papers is incomplete sharing of data or code.
We end the paper by discussing strategies for researchers and the subfield to correct for this disheartening state of computational reproducibility.
}